...
im= cv2.imread("15IT245_M3_image.bmp",0) 
...
cv2.imwrite("15IT245_M3_grayscale.bmp",im)
#print img[0,0]

img = cv2.imread("15IT245_M3_grayscale.bmp",0) 
...
# cv2.waitKey(0)
cv2.imwrite("15IT245_M3_encrypted.bmp",pixel3)
...
msg= cv2.imread("15IT245_M3_encrypted.bmp",0) 
...
cv2.imwrite("15IT245_M3_decrypted.bmp",pixel2_dec)

img_gray = cv2.imread("15IT245_M3_grayscale.bmp",0)

img_dec = cv2.imread("15IT245_M3_decrypted.bmp",0) 
