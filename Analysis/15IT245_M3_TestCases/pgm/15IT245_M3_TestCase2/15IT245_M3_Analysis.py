...
im= cv2.imread("15IT245_M3_image.pgm",0) 
...
cv2.imwrite("15IT245_M3_grayscale.pgm",im)
#print img[0,0]

img = cv2.imread("15IT245_M3_grayscale.pgm",0) 
...
# cv2.waitKey(0)
cv2.imwrite("15IT245_M3_encrypted.pgm",pixel3)
...
msg= cv2.imread("15IT245_M3_encrypted.pgm",0) 
...
cv2.imwrite("15IT245_M3_decrypted.pgm",pixel2_dec)

img_gray = cv2.imread("15IT245_M3_grayscale.pgm",0)

img_dec = cv2.imread("15IT245_M3_decrypted.pgm",0) 
