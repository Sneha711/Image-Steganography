...
im= cv2.imread("15IT245_M3_image.png",0) 
...
cv2.imwrite("15IT245_M3_grayscale.png",im)
#print img[0,0]

img = cv2.imread("15IT245_M3_grayscale.png",0) 
...
# cv2.waitKey(0)
cv2.imwrite("15IT245_M3_encrypted.png",pixel3)
...
msg= cv2.imread("15IT245_M3_encrypted.png",0) 
...
cv2.imwrite("15IT245_M3_decrypted.png",pixel2_dec)

img_gray = cv2.imread("15IT245_M3_grayscale.png",0)

img_dec = cv2.imread("15IT245_M3_decrypted.png",0) 
...
print "i) Horizontal"
print "The correlation coefficient of original image is:", coef
print "The correlation coefficient of encrypted image is:", coef_enc
...
for j in range(cols):
	for i in range(rows):
		if i < rows -1:
			ver_mat[i][j] = img[i+1][j] 
			ver_mat_enc[i][j] = msg[i+1][j]
